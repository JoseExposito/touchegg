/**
 * @file /src/touchegg/gestures/implementations/FourFingersTap.h
 *
 * @~spanish
 ...
 */
#ifndef FOURFINGERSTAP_H
#define FOURFINGERSTAP_H
...
/**
 * @~spanish
 * Click con cuatro dedos.
 *
 * @~english
 * Four fingers click.
 */
class FourFingersTap : public Gesture {
    ...
    public:
         ...
         *        the attribute.
         */
        FourFingersTap(GestureTypeEnum::GestureType type, GeisGestureId id,
