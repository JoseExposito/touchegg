/**
 * @file /src/touchegg/gestures/implementations/ThreeFingersDragUp.h
 *
 * @~spanish
 ...
 */
#ifndef THREEFINGERSDRAGUP_H
#define THREEFINGERSDRAGUP_H
...
/**
 * @~spanish
 * Arrastrar tres dedos hacia arriba.
 *
 * @~english
 * Drag three fingers up.
 */
class ThreeFingersDragUp : public Gesture {
    ...
    public:
         ...
         *        the attribute.
          */
        ThreeFingersDragUp(GestureTypeEnum::GestureType type, GeisGestureId id,
