/**
 * @file /src/touchegg/gestures/implementations/TwoFingersDragUp.h
 *
 * @~spanish
 ...
 *
 * @class  TwoFingersDragUp
 * @author José Expósito
 */
#ifndef TWOFINGERSDRAGUP_H
#define TWOFINGERSDRAGUP_H
 ...
 * Drag two fingers.
 */
class TwoFingersDragUp : public Gesture {
    ...
    public:
         ...
         *        the attribute.
          */
        TwoFingersDragUp(GestureTypeEnum::GestureType type, GeisGestureId id,
