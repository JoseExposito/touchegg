/**
 * @file /src/touchegg/gestures/gesturesimp/TwoFingersDragDown.cpp
 *
 * @~spanish
 ...
 */
#include "TwoFingersDragDown.h"

// ************************************************************************** //
// **********              CONSTRUCTORS AND DESTRUCTOR             ********** //
// ************************************************************************** //

TwoFingersDragDown::TwoFingersDragDown(GeisGestureType type, GeisGestureId id,
...
bool TwoFingersDragDown::isThisGesture(const QHash<QString, QVariant>& attrs) {
    // "gesture name" = "Drag"
