/**
 * @file /src/touchegg/gestures/gesturesimp/ThreeFingersDragRight.cpp
 *
 * @~spanish
 ...
 */
#include "ThreeFingersDragRight.h"

// ************************************************************************** //
// **********              CONSTRUCTORS AND DESTRUCTOR             ********** //
// ************************************************************************** //

ThreeFingersDragRight::ThreeFingersDragRight(GeisGestureType type, GeisGestureId id,
...
bool ThreeFingersDragRight::isThisGesture(const QHash<QString, QVariant>& attrs) {
    // "gesture name" = "Drag"
