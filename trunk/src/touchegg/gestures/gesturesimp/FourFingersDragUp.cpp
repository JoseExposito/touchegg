/**
 * @file /src/touchegg/gestures/gesturesimp/FourFingersDragUp.cpp
 *
 * @~spanish
 ...
 */
#include "FourFingersDragUp.h"

// ************************************************************************** //
// **********              CONSTRUCTORS AND DESTRUCTOR             ********** //
// ************************************************************************** //

FourFingersDragUp::FourFingersDragUp(GeisGestureType type, GeisGestureId id,
...
bool FourFingersDragUp::isThisGesture(const QHash<QString, QVariant>& attrs) {
    // "gesture name" = "Drag"
