/**
 * @file /src/touchegg/gestures/implementations/FourFingersDragUp.h
 *
 * @~spanish
 ...
 *
 * @class  FourFingersDragUp
 * @author José Expósito
 */
#ifndef FOURFINGERSDRAGUP_H
#define FOURFINGERSDRAGUP_H
...
/**
 * @~spanish
 * Arrastrar cuatro dedos hacia arriba.
 *
 * @~english
 * Drag four fingers up.
 */
class FourFingersDragUp : public Gesture {
    ...
    public:
         ...
         *        the attribute.
         */
        FourFingersDragUp(GestureTypeEnum::GestureType type, GeisGestureId id,
