/**
 * @file /src/touchegg/gestures/implementations/OneFingerTap.h
 *
 * @~spanish
 ...
 */
#ifndef ONEFINGERTAP_H
#define ONEFINGERTAP_H
 ...
 * One finger click.
 */
class OneFingerTap : public Gesture {
    ...
    public:
         ...
         *        the attribute.
         */
        OneFingerTap(GestureTypeEnum::GestureType type, GeisGestureId id,
