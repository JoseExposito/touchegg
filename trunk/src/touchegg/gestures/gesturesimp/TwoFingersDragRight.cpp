/**
 * @file /src/touchegg/gestures/gesturesimp/TwoFingersDragRight.cpp
 *
 * @~spanish
 ...
 */
#include "TwoFingersDragRight.h"

// ************************************************************************** //
// **********              CONSTRUCTORS AND DESTRUCTOR             ********** //
// ************************************************************************** //

TwoFingersDragRight::TwoFingersDragRight(GeisGestureType type, GeisGestureId id,
...
bool TwoFingersDragRight::isThisGesture(const QHash<QString, QVariant>& attrs) {
    // "gesture name" = "Drag"
