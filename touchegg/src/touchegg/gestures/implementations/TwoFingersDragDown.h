/**
 * @file /src/touchegg/gestures/implementations/TwoFingersDragDown.h
 *
 * @~spanish
 ...
 *
 * @class  TwoFingersDragDown
 * @author José Expósito
 */
#ifndef TWOFINGERSDRAGDOWN_H
#define TWOFINGERSDRAGDOWN_H
...
/**
 * @~spanish
 * Arrastrar dos dedos hacia abajo.
 *
 * @~english
 * Drag two fingers down.
 */
class TwoFingersDragDown : public Gesture {
    ...
    public:
         ...
         */
        TwoFingersDragDown(GestureTypeEnum::GestureType type, GeisGestureId id,
