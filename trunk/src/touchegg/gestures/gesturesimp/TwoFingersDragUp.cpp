/**
 * @file /src/touchegg/gestures/gesturesimp/TwoFingersDragUp.cpp
 *
 * @~spanish
 ...
 */
#include "TwoFingersDragUp.h"

// ************************************************************************** //
// **********              CONSTRUCTORS AND DESTRUCTOR             ********** //
// ************************************************************************** //

TwoFingersDragUp::TwoFingersDragUp(GeisGestureType type, GeisGestureId id,
...
bool TwoFingersDragUp::isThisGesture(const QHash<QString, QVariant>& attrs) {
    // "gesture name" = "Drag"
