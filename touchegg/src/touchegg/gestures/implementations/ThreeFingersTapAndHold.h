/**
 * @file /src/touchegg/gestures/implementations/ThreeFingersTapAndHold.h
 *
 * @~spanish
 ...
 */
#ifndef THREEFINGERSTAPANDHOLD_H
#define THREEFINGERSTAPANDHOLD_H
...
/**
 * @~spanish
 * Equivalente a hacer un tap y luego un drag con tres dedos.
 *
 * @~english
 * Equivalent to make a tap and then a drag with three fingers.
 */
class ThreeFingersTapAndHold : public Gesture {
    ...
    public:
         ...
         */
        ThreeFingersTapAndHold(GestureTypeEnum::GestureType type,
...
#endif // THREEFINGERSTAPANDHOLD_H
