/**
 * @file /src/touchegg/gestures/gesturesimp/ThreeFingersDragLeft.cpp
 *
 * @~spanish
 ...
 */
#include "ThreeFingersDragLeft.h"

// ************************************************************************** //
// **********              CONSTRUCTORS AND DESTRUCTOR             ********** //
// ************************************************************************** //

ThreeFingersDragLeft::ThreeFingersDragLeft(GeisGestureType type, GeisGestureId id,
...
bool ThreeFingersDragLeft::isThisGesture(const QHash<QString, QVariant>& attrs) {
    // "gesture name" = "Drag"
