/**
 * @file /src/touchegg/gestures/implementations/ThreeFingersDragDown.h
 *
 * @~spanish
 ...
 *
 * @class  ThreeFingersDragDown
 * @author José Expósito
 */
#ifndef THREEFINGERSDRAGDOWN_H
#define THREEFINGERSDRAGDOWN_H
 ...
 */
class ThreeFingersDragDown : public Gesture {
    ...
    public:
         ...
         */
        ThreeFingersDragDown(GestureTypeEnum::GestureType type, GeisGestureId id,
