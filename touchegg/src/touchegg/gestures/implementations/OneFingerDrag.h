/**
 * @file /src/touchegg/gestures/implementations/OneFingerDrag.h
 *
 * @~spanish
 ...
 */
#ifndef ONEFINGERDRAG_H
#define ONEFINGERDRAG_H
...
/**
 * @~spanish
 * Arrastrar un dedo hacia arriba.
 *
 * @~english
 * Drag one finger up.
 */
class OneFingerDrag : public Gesture {
    ...
    public:
         ...
         *        the attribute.
         */
        OneFingerDrag(GestureTypeEnum::GestureType type, GeisGestureId id,
