/**
 * @file /src/touchegg/gestures/implementations/FourFingersDragLeft.h
 *
 * @~spanish
 ...
 */
#ifndef FOURFINGERSDRAGLEFT_H
#define FOURFINGERSDRAGLEFT_H
...
/**
 * @~spanish
 * Arrastrar cuatro dedos hacia la izquierda.
 *
 * @~english
 * Drag four fingers left.
 */
class FourFingersDragLeft : public Gesture {
     ...
     */
    FourFingersDragLeft(GestureTypeEnum::GestureType type, GeisGestureId id,
