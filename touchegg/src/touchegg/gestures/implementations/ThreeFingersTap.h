/**
 * @file /src/touchegg/gestures/implementations/ThreeFingersTap.h
 *
 * @~spanish
 ...
 */
#ifndef THREEFINGERSTAP_H
#define THREEFINGERSTAP_H
...
/**
 * @~spanish
 * Click con tres dedos.
 *
 * @~english
 * Three fingers click.
 */
class ThreeFingersTap : public Gesture {
    ...
    public:
         ...
         */
        ThreeFingersTap(GestureTypeEnum::GestureType type, GeisGestureId id,
