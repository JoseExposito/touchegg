/**
 * @file /src/touchegg/gestures/gesturesimp/ThreeFingersDragDown.cpp
 *
 * @~spanish
 ...
 */
#include "ThreeFingersDragDown.h"

// ************************************************************************** //
// **********              CONSTRUCTORS AND DESTRUCTOR             ********** //
// ************************************************************************** //

ThreeFingersDragDown::ThreeFingersDragDown(GeisGestureType type, GeisGestureId id,
...
bool ThreeFingersDragDown::isThisGesture(const QHash<QString, QVariant>& attrs) {
    // "gesture name" = "Drag"
