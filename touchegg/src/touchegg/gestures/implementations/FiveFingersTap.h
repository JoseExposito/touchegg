/**
 * @file /src/touchegg/gestures/implementations/FiveFingersTap.h
 *
 * @~spanish
 ...
 */
#ifndef FIVEFINGERSTAP_H
#define FIVEFINGERSTAP_H
...
/**
 * @~spanish
 * Click con cinco dedos.
 *
 * @~english
 * Five fingers click.
 */
class FiveFingersTap : public Gesture {
    ...
    public:
         ...
         *        the attribute.
         */
        FiveFingersTap(GestureTypeEnum::GestureType type, GeisGestureId id,
