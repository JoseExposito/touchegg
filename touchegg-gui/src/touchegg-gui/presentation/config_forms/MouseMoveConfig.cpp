/**
 * @file /src/touchegg-gui/presentation/config_forms/MouseMoveConfig.cpp
 *
 * @~spanish
 ...
 */
#include "MouseMoveConfig.h"

// ************************************************************************** //
// **********              CONSTRUCTORS AND DESTRUCTOR             ********** //
// ************************************************************************** //

MouseMoveConfig::MouseMoveConfig() {
...
QString MouseMoveConfig::getSettings() const {
    QString speed;
    speed.setNum(this->slider->value());
    return "SPEED=" + speed;
}

void MouseMoveConfig::setSettings(const QString& settings) {
