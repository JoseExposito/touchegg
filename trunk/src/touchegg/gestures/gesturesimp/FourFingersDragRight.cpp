/**
 * @file /src/touchegg/gestures/gesturesimp/FourFingersDragRight.cpp
 *
 * @~spanish
 ...
 */
#include "FourFingersDragRight.h"

// ************************************************************************** //
// **********              CONSTRUCTORS AND DESTRUCTOR             ********** //
// ************************************************************************** //

FourFingersDragRight::FourFingersDragRight(GeisGestureType type, GeisGestureId id,
...
bool FourFingersDragRight::isThisGesture(const QHash<QString, QVariant>& attrs) {
    // "gesture name" = "Drag"
