/**
 * @file /src/touchegg/gestures/implementations/FourFingersDragDown.h
 *
 * @~spanish
 ...
 */
#ifndef FOURFINGERSDRAGDOWN_H
#define FOURFINGERSDRAGDOWN_H
 ...
 */
class FourFingersDragDown : public Gesture {
     ...
     *        the attribute.
     */
    FourFingersDragDown(GestureTypeEnum::GestureType type, GeisGestureId id,
