/**
 * @file /src/touchegg/gestures/implementations/FiveFingersTapAndHold.h
 *
 * @~spanish
 ...
 */
#ifndef FIVEFINGERSTAPANDHOLD_H
#define FIVEFINGERSTAPANDHOLD_H
...
/**
 * @~spanish
 * Equivalente a hacer un tap y luego un drag con cinco dedos.
 *
 * @~english
 * Equivalent to make a tap and then a drag with five fingers.
 */
class FiveFingersTapAndHold : public Gesture {
    ...
    public:
         ...
         *        the attribute.
         */
        FiveFingersTapAndHold(GestureTypeEnum::GestureType type,
