/**
 * @file /src/touchegg/gestures/implementations/ThreeFingersPinch.h
 *
 * @~spanish
 ...
 */
#ifndef THREEFINGERSPINCH_H
#define THREEFINGERSPINCH_H
 ...
 */
class ThreeFingersPinch : public Gesture {
    ...
    public:
         ...
         */
        ThreeFingersPinch(GestureTypeEnum::GestureType type, GeisGestureId id,
