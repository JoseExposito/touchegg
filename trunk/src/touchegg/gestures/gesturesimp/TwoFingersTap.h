/**
 * @file /src/touchegg/gestures/gesturesimp/TwoFingersTap.h
 *
 * @~spanish
 ...
 */
#ifndef TWOFINGERSTAP_H
#define TWOFINGERSTAP_H
 ...
 * Two fingers click.
 */
class TwoFingersTap : public Gesture {
    ...
    public:
         ...
         */
        TwoFingersTap(GeisGestureType type, GeisGestureId id,
