/**
 * @file /src/touchegg/gestures/implementations/TwoFingersDragRight.h
 *
 * @~spanish
 ...
 *
 * @class  TwoFingersDragRight
 * @author José Expósito
 */
#ifndef TWOFINGERSDRAGRIGHT_H
#define TWOFINGERSDRAGRIGHT_H
 ...
 * Drag two fingers.
 */
class TwoFingersDragRight : public Gesture {
    ...
    public:
         ...
         *        the attribute.
          */
        TwoFingersDragRight(GestureTypeEnum::GestureType type, GeisGestureId id,
