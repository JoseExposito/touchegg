/**
 * @file /src/touchegg/gestures/implementations/FourFingersTapAndHold.h
 *
 * @~spanish
 ...
 */
#ifndef FOURFINGERSTAPANDHOLD_H
#define FOURFINGERSTAPANDHOLD_H
...
/**
 * @~spanish
 * Equivalente a hacer un tap y luego un drag con cuatro dedos.
 *
 * @~english
 * Equivalent to make a tap and then a drag with four fingers.
 */
class FourFingersTapAndHold : public Gesture {
    ...
    public:
         ...
         *        the attribute.
         */
        FourFingersTapAndHold(GestureTypeEnum::GestureType type,
