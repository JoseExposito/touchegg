/**
 * @file /src/touchegg/gestures/implementations/TwoFingersDragLeft.h
 *
 * @~spanish
 ...
 */
#ifndef TWOFINGERSDRAGLEFT_H
#define TWOFINGERSDRAGLEFT_H
 ...
 * Drag two fingers.
 */
class TwoFingersDragLeft : public Gesture {
    ...
    public:
         ...
         */
        TwoFingersDragLeft(GestureTypeEnum::GestureType type, GeisGestureId id,
